...
/**
 * @file    mod_lang_compile_I_bundle.c
...
static mod_iid_t mod_lang_compile_iid = MOD_LANG_COMPILE_IID;
...
{
    STD_ASSERT_RV(mod_register_instance_func(&mod_lang_compile_iid, mod_lang_compile_I_create_instance) ==
                          STD_RV_SUC,
                  STD_RV_ERR_FAIL);
    STD_ASSERT_RV(mod_bundle_IID_register(bundle_service_id, &mod_lang_compile_iid) == STD_RV_SUC, STD_RV_ERR_FAIL);
...
{
    STD_ASSERT_RV(mod_unregister_instance_func(&mod_lang_compile_iid) == STD_RV_SUC, );

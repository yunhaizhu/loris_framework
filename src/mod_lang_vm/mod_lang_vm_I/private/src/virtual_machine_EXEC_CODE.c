...
OP_CODE_LOAD_LIB:
    ...
    do {
        ...
        switch (Codes[*Pc].opcode) {
            ...
            case Inp_ADD:
                inline_execute_code_Inp_ADD(thread_id);
                break;
            ...
            case Inp_SUB:
                inline_execute_code_Inp_SUB(thread_id);
                break;
            ...
            case Inp_MUL:
                inline_execute_code_Inp_MUL(thread_id);
                break;
            ...
            case Inp_DIV:
                inline_execute_code_Inp_DIV(thread_id);
                break;
            ...
            case Inp_MOD:
                inline_execute_code_Inp_MOD(thread_id);
                break;
            case GT:
                inline_execute_code_GT(thread_id);
                break;
            ...
            case LOADA:
                inline_execute_code_LOADA(thread_id, Codes, Stack, Pc, Fp, Sp);
                break;

            case LOADL:
                inline_execute_code_LOADL(thread_id, Codes, Stack, Pc, Fp, Sp);
                break;
